...
public interface kidListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link kidParser#qstmt}.
	 * @param ctx the parse tree
	 */
	void enterQstmt(kidParser.QstmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link kidParser#qstmt}.
	 * @param ctx the parse tree
	 */
	void exitQstmt(kidParser.QstmtContext ctx);
	/**
